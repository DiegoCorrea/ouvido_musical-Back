...
class UserAverageOverview:
    ...
    def __all_time_graph_line(self):
        self.__logger.info("[Start User Average - Run Time - (Graph Line)]")
        plt.figure()
        plt.grid(True)
        plt.xlabel('Rodada')
        ...
        plt.close()
        self.__logger.info("[Finish User Average - Run Time - (Graph Line)]")
    ...
    def __all_time_graph_box_plot(self):
        ...
        plt.close()
        self.__logger.info("[Finish User Average - Run Time - (Graph BoxPlot)]")
